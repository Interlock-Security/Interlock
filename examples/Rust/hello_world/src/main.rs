...
fn close_the_application (_e: Webui::webinix_event_t) {

    Webui::Exit();
}

fn check_the_password (e: Webui::webinix_event_t) {
...
fn main() {
    ...
    <html><head><title>Webinix 2 - Rust Example</title>
    ...
    <h1>Webinix 2 - Rust Example</h1><br>
