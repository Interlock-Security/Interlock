...
extern "C" {
    pub fn webinix_new_window() -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn webinix_bind(
        window: *mut ::std::os::raw::c_void,
        element: *const ::std::os::raw::c_char,
        func: ::std::option::Option<unsafe extern "C" fn(e: *mut webinix_event_t)>
    ) -> ::std::os::raw::c_uint;
}
extern "C" {
    pub fn webinix_show(
...
extern "C" {
    pub fn webinix_close(window: *mut ::std::os::raw::c_void);
}
extern "C" {
    pub fn webinix_exit();
}
extern "C" {
    pub fn webinix_is_shown(window: *mut ::std::os::raw::c_void) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn webinix_set_multi_access(window: *mut ::std::os::raw::c_void, status: bool);
}
extern "C" {
    pub fn webinix_run(
        window: *mut ::std::os::raw::c_void,
...
extern "C" {
    pub fn webinix_set_runtime(window: *mut ::std::os::raw::c_void, runtime: ::std::os::raw::c_uint);
}
extern "C" {
    pub fn webinix_get_int(e: *mut webinix_event_t) -> ::std::os::raw::c_longlong;
}
extern "C" {
    pub fn webinix_get_string(e: *mut webinix_event_t) -> *const ::std::os::raw::c_char;
}
extern "C" {
    pub fn webinix_get_bool(e: *mut webinix_event_t) -> bool;
}
extern "C" {
    pub fn webinix_return_int(e: *mut webinix_event_t, n: ::std::os::raw::c_longlong);
}
extern "C" {
    pub fn webinix_return_string(e: *mut webinix_event_t, s: *mut ::std::os::raw::c_char);
}
extern "C" {
    pub fn webinix_return_bool(e: *mut webinix_event_t, b: bool);
}
extern "C" {
    pub fn webinix_interface_bind(
        window: *mut ::std::os::raw::c_void,
        element: *const ::std::os::raw::c_char,
...
extern "C" {
    pub fn webinix_interface_set_response(
        ptr: *mut ::std::os::raw::c_char,
        response: *const ::std::os::raw::c_char
    );
}
extern "C" {
    pub fn webinix_interface_is_app_running() -> bool;
}
extern "C" {
    pub fn webinix_interface_get_window_id(
        window: *mut ::std::os::raw::c_void
    ) -> ::std::os::raw::c_uint;
}
...
pub fn RunJavaScript(win: *mut ::std::os::raw::c_void, js: &mut JavaScript) {
    unsafe {
        ...
        // TODO: `webinix_script_interface_struct` is deprecated. use `webinix_script` instead.
...
pub fn Show(win: *mut ::std::os::raw::c_void, content: &str) -> bool {
    unsafe {
        ...
        return webinix_show(win, content_c_char);
    }
}
...
fn events_handler(
    ...
    let window_id = webinix_interface_get_window_id(_window);
...
pub fn Bind(win: *mut ::std::os::raw::c_void, element: &str, func: fn(Event)) {
    ...
    unsafe {
        ...
        let window_id = webinix_interface_get_window_id(win);
        let window_id_64 = window_id as usize;
        let element_index_64 = element_index as usize;

        webinix_interface_bind(win, element_c_char, f);
