  ...
  webinix_lib = Deno.dlopen(
    lib_path,
    {
      ...
      webinix_interface_bind: {
        // unsigned int webinix_interface_bind(void* window, const char* element, void (*func)(void*, int, char*, char*, char*))
...
export function bind(win: Deno.Pointer, element: string, func: Function) {
  ...
  const callbackResource = new Deno.UnsafeCallback(
    ...
    (
      ...
      webinix_lib.symbols.webinix_interface_set_response(param_response, string_to_uint8array(result));
    },
  );
