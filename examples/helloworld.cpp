...
webinix::window dashboard_window;

void run_javascript(webinix::event e){
...
void close_app(webinix::event e){

	// Close all opened windows
	// this make webinix::loop() to finish
	webinix::exit();
}
...
int main(){
	...
	// Show window
	if(!my_window.show(&my_html, webinix::browser::chrome))	// If Google Chrome not installed
