...
/**
 * @brief Get the web-server network port to be used by Webinix.
 ...
 *  web-server network port Webinix should use
 *
...
/**
 * @brief Get an available network port to be used by your app or by Webinix.
 *
