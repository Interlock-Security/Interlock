...
WEBUI_EXPORT void* webinix_new_window(void);
// Bind a specific html element click event with a function. Empty element means all events.
WEBUI_EXPORT unsigned int webinix_bind(void* window, const char* element, void (*func)(webinix_event_t* e));
...
WEBUI_EXPORT bool webinix_set_kiosk(void* window, bool kiosk);
// Wait until all opened windows get closed.
WEBUI_EXPORT void webinix_wait(void);
// Close a specific window.
WEBUI_EXPORT void webinix_close(void* window);
// Close all opened windows. webinix_wait() will break.
WEBUI_EXPORT void webinix_exit(void);

// -- Other ---------------------------
// Check a specific window if it's still running
WEBUI_EXPORT bool webinix_is_shown(void* window);
// Set the maximum time in seconds to wait for browser to start
WEBUI_EXPORT void webinix_set_timeout(unsigned int second);
// Set the default embedded HTML favicon
WEBUI_EXPORT void webinix_set_icon(void* window, const char* icon, const char* icon_type);
// Allow the window URL to be re-used in normal web browsers
WEBUI_EXPORT void webinix_set_multi_access(void* window, bool status);

// -- JavaScript ----------------------
// Run JavaScript quickly with no waiting for the response.
WEBUI_EXPORT bool webinix_run(void* window, const char* script);
// Run a JavaScript, and get the response back (Make sure your local buffer can hold the response).
WEBUI_EXPORT bool webinix_script(void* window, const char* script, unsigned int timeout, char* buffer, size_t buffer_length);
// Chose between Deno and Nodejs runtime for .js and .ts files.
WEBUI_EXPORT void webinix_set_runtime(void* window, unsigned int runtime);
...
WEBUI_EXPORT void webinix_return_string(webinix_event_t* e, char* s);
...
WEBUI_EXPORT unsigned int webinix_interface_bind(void* window, const char* element, void (*func)(void*, unsigned int, char*, char*, unsigned int));
// When using `webinix_interface_bind()` you may need this function to easily set your callback response.
WEBUI_EXPORT void webinix_interface_set_response(void* window, unsigned int event_number, const char* response);
...
WEBUI_EXPORT unsigned int webinix_interface_get_window_id(void* window);
