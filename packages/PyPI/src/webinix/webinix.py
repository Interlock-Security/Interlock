...
class window:
    ...
    def show(self, html="<html></html>", browser=0):
        ...
        if Webinix is None:
            ...
            return
        Webinix.webinix_show_cpy(self.window, 
    ...
    def refresh(self, html="<html></html>"):
        ...
        if Webinix is None:
            err_library_not_found('show')
            return
        Webinix.webinix_refresh_cpy(self.window, 
                            html.encode('utf-8'))
    ...
    def open(self, url, browser=0):
        ...
        if Webinix is None:
            ...
            return
        Webinix.webinix_open(self.window, 
    ...
    def script_runtime(self, rt=runtime.deno):
        ...
        if Webinix is None:
            ...
            return
        Webinix.webinix_script_runtime(self.window, 
                        ctypes.c_uint(rt))
    ...
    def new_server(self, path=""):
        ...
        if Webinix is None:
            ...
            return
        webinix_wrapper = None
        webinix_wrapper = Webinix.webinix_new_server
        webinix_wrapper.argtypes = [c_void_p, c_void_p]
        webinix_wrapper.restype = c_char_p
        url = c_char_p(webinix_wrapper(self.window,
    ...
    def multi_access(self, status=False):
        ...
        if Webinix is None:
            ...
            return
        Webinix.webinix_multi_access(self.window, 
    ...
    def is_any_window_running(self):
        ...
        if Webinix is None:
            err_library_not_found('close')
            return
        r = bool(Webinix.webinix_is_any_window_running())
        return r
    ...
    def run_js(self, script, timeout=0) -> javascript:
        ...
        res.data = "UNKNOWN"
        # Run JavaScript
        Webinix.webinix_script_interface_struct(self.window, 
                                            ctypes.byref(js))
...
def is_app_running():
    ...
    if Webinix is None:
        ...
        if Webinix is None:
            ...
            return
    r = bool(Webinix.webinix_is_app_running())
    return r
