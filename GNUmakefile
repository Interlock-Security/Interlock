...
#	Dynamic with Debug info
	...
	&& $(CC) $(TARGET) -shared -o $(LIB_DYN_OUT) webinix.o civetweb.o -g -L"$(WEBUI_TLS_LIB)" $(TLS_LDFLAG_DYNAMIC) $(LWS2_OPT)
ifeq ($(PLATFORM),windows)
...
#	Dynamic Release
	...
	&& $(CC) $(TARGET) -shared -o $(LIB_DYN_OUT) webinix.o civetweb.o -L"$(WEBUI_TLS_LIB)" $(TLS_LDFLAG_DYNAMIC) $(LWS2_OPT)
#	Clean
ifeq ($(PLATFORM),windows)
