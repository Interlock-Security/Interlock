...
WEBUI_BUILD_FLAGS := -o webinix.o -I"$(MAKEFILE_DIR)/include/" -c "$(MAKEFILE_DIR)/src/webinix.c"
...
#	Dynamic with Debug info
	...
	&& $(CC) $(TARGET) -shared -o $(LIB_DYN_OUT) webinix.o civetweb.o -g $(LWS2_OPT)
ifeq ($(PLATFORM),windows)
...
#	Dynamic Release
	...
	&& $(CC) $(TARGET) -shared -o $(LIB_DYN_OUT) webinix.o civetweb.o $(LWS2_OPT)
#	Clean
ifeq ($(PLATFORM),windows)
