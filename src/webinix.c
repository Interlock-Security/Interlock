...
void webinix_set_center(size_t window) {
    ...
    if (getenv("WAYLAND_DISPLAY")) {
        ...
        // Note:
        // This will make Webinix depend on Wayland dev libraries (libwayland-client-dev).
        // Let's avoid Wayland to keep Webinix portable as possible.

        #ifdef WEBUI_LOG
        printf("[User] webinix_set_center() -> Wayland is not supported.\n");
        #endif
    } else {
        // X11 environment
        ...
        // Note:
        // This will make Webinix depend on X11 dev libraries (libx11-dev).
        // Let's avoid X11 to keep Webinix portable as possible.

        #ifdef WEBUI_LOG
        printf("[User] webinix_set_center() -> X11 is not supported.\n");
        #endif
    }
    #endif
