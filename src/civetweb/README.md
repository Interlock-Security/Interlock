...
- Allow compiling with swift compiler chaning an incompatible structname
  ...
  Rename struct `ah` to `auth_header` [civetweb.c#L8715](https://github.com/webinix-dev/webinix/blob/ea5540c833b3e4ae38cc8dc7d62965a8507a78ee/src/civetweb/civetweb.c#L8715)
