...
For more instructions, please visit [Build Webinix](https://github.com/webinix-dev/webinix/tree/main/build) in our GitHub repository.
...
Please visit [C++ Examples](https://github.com/webinix-dev/webinix/tree/main/examples/C%2B%2B) in our GitHub repository for instructions on compiling this example or finding more complete examples.
